            ...
            <div className='py-2 px-4 border border-blue-600/30 rounded flex justify-between shadow-sm'>
                ...
                <form className='flex items-center'>
                    ...
                    <div className={isEdit ? "flex flex-nowrap" : "hidden"}>
                        <input onChange={(e) => setInputEdit({ ...props.data, name: e.target.value })} className="border-b border-black/20 shadow-blue-50 focus:outline-none" value={inputEdit.name} />
                        <button onClick={(e) => editTask(e)} className="flex-none bg-black text-white text-xs px-1 py-0 rounded">OK</button>
                    </div>
                </form>
